...
import section1Img from '../assets/image/newLogo.png'
...
const Home = () => {
  return (
    <>
      <nav className='flex justify-between px-14 sm:px-5 bg-green-500 h-20 sm:h-16 text-white items-center ' style={{ fontFamily: '"Josefin Sans", sans-serif', position: "sticky", top: "0" }}>
      ...
      <div className="section2 w-full h-[30em] bg-slate-100 flex border-b-8 border-slate-200 sm:flex-col" style={{ fontFamily: '"Josefin Sans", sans-serif' }}>
        <div className='w-hf sm:w-full sm:mt-10 sm:h-hf flex mt-[-2em] items-center'>
          <div className='ms-[10%]'>
            <h1 className='text-[2.6em] sm:text-[1.4em] text-bold text-blue-600 border-s-8 border-blue-600 ps-4 rounded-[5px]'>Chat very fast </h1>
            <p className='text-[3em] sm:text-[1em] ps-6 text-red-500 '>Chat, have some fun</p>
            <h2 className='ps-6'><span className='text-blue-600 text-[1.7em] sm:text-[1em]'> <i>Chat easy,</i></span><span className='text-red-500 text-[2.2em] sm:text-[1.3em]'> <i>Stay Happy.</i></span> </h2>
            <Link to='/signup'>
      ...
      <div className="section2 w-full h-[30em] bg-white flex sm:flex-col-reverse" style={{ fontFamily: '"Josefin Sans", sans-serif' }}>
        ...
        <div className='w-hf sm:w-full sm:h-hf flex mt-[-4em] items-center border-blue-50'>
          <div className='ms-[10%]'>
            <h1 className='text-[2.8em] text-bold border-blue-600 text-blue-800 rounded-[5px]'>Fast Response</h1>
            <p className='mt-3 text-lg text-blue-700 w-[70%] '>You will be able to chat with people from all over the world...</p>
          </div>
        </div>
      </div>
      {/* Section  3*/}
