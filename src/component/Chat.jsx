...
//                         <h2 className="text-xl font-bold mb-4 text-gray-900 bg-gray-100 border-t rounded-sm p-1 border-gray-300 flex">Users <span className='ml-60 mt-2 lg-ml-100' onClick={dropdown}
                        
//                         ><TiThMenuOutline  /></span></h2> <button><Link to='/signin' className='text-blue-500 text-2xl font-bold -mt-5'>Log out</Link></button>
            ...
            <div className="flex flex-col md:flex-row h-screen">
                {!isChatting ? (
                    <div className="md:w-1/4 w-full p-4 border-b md:border-b-0 md:border-r border-gray-300 overflow-y-auto">
                        ...
                        <button>
                            <Link to='/signin' className='text-blue-500 text-2xl font-bold -mt-5'>Log out</Link>
                        </button>
                        <div className="space-y-2">
                            {users.map((item, i) => (
                                <div
